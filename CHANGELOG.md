...
- zakładka okien dostępu przechwytuje błąd zbyt odległej epoki OMM zamiast wyświetlać traceback;
- tryb demonstracyjny pozwala jawnie użyć OMM starszych niż 72 h i oznacza wynik jako orientacyjny.
